...
class BranchComparisonController extends GetxController {

   // ── title passed from caller ──────────────────────────────────────────
  final String screenTitle;

  BranchComparisonController({this.screenTitle = 'revenue.title'});
  ...
  final RxList<BranchComparisonColumn> allColumns = <BranchComparisonColumn>[
    BranchComparisonColumn(key: 'branch', label: 'Branch', width: 110, isSelected: true),
    BranchComparisonColumn(key: 'from', label: 'From', width: 110, isSelected: true),
    BranchComparisonColumn(key: 'to', label: 'To', width: 110, isSelected: true),
    BranchComparisonColumn(key: 'totalAmount', label: 'Total Amount', width: 130, isSelected: true),
    BranchComparisonColumn(key: 'totalDiscount', label: 'Total Discount', width: 130, isSelected: true),
    BranchComparisonColumn(key: 'totalPaidAmount', label: 'Total Paid Amount', width: 145, isSelected: true),
    BranchComparisonColumn(key: 'totalBalanceAmount', label: 'Total Balance Amount', width: 165, isSelected: true),
    BranchComparisonColumn(key: 'cashCount', label: 'Cash Count', width: 120, isSelected: false),
    BranchComparisonColumn(key: 'onlinePayment', label: 'Online Payment', width: 140, isSelected: false),
    BranchComparisonColumn(key: 'serviceAmount', label: 'Service Amount', width: 140, isSelected: false),
    BranchComparisonColumn(key: 'productAmount', label: 'Product Amount', width: 140, isSelected: false),
    BranchComparisonColumn(key: 'packageAmount', label: 'Package Amount', width: 140, isSelected: false),
  ].obs;
  ...
  // ── dummy data ────────────────────────────────────────────────────────
  final List<BranchComparisonRow> _allData = List.generate(
    25,
    (i) => BranchComparisonRow(
      index: i + 1,
      branch: 'Demo',
      from: 'Aug/1/2026',
      to: 'Aug/1/2026',
  ...
  RxList<BranchComparisonRow> get pagedData {
  ...
  // ── computed ──────────────────────────────────────────────────────────
  List<BranchComparisonColumn> get selectedColumns =>
  ...
  String getCellValue(BranchComparisonRow row, String key) {
    switch (key) {
