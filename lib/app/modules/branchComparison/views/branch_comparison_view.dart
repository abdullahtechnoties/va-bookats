...
import 'package:va_bookats/app/modules/branchComparison/views/Widgets/column-selector-sheet.dart';
import 'package:va_bookats/app/modules/branchComparison/views/Widgets/revenue-filter-sheet.dart';
import 'package:va_bookats/app/modules/branchComparison/views/Widgets/revenue-table.dart';
...
class BranchComparisonView extends GetView<BranchComparisonController> {
          ...
          child: Column(
            children: [
              ClipRRect(
                ...
                child: BranchComparisonTableWidget(
  ...
  void _openColumnSelector(BuildContext context) {
    showModalBottomSheet(
      ...
      isScrollControlled: true,
      backgroundColor: AppColors.transparent,
      builder: (_) => BranchComparisonColumnSelectorSheet(controller: controller),
    );
  }
}
