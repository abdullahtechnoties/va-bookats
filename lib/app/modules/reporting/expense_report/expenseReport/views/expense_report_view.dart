...
import 'package:va_bookats/app/modules/reporting/expense_report/expenseReport/views/widgets/expense_filter_sheet.dart';
import 'package:va_bookats/app/modules/reporting/expense_report/expenseReport/views/widgets/expense_table.dart';
...
class ExpenseReportView extends GetView<ExpenseReportController> {
          ...
          child: Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    '${'expense.columns.selected'.trns()} (${controller.selectedColumnCount})',
                    style: const TextStyle(
                      fontSize: 12,
                      fontWeight: FontWeight.w500,
                      color: Color(0xFF374151),
  ...
  Widget _buildTableSection(BuildContext context) {
    return Obx(() {
      final rows = controller.monthlyData.toList();
      return SingleChildScrollView(
        ...
        child: Padding(
          ...
          child: ClipRRect(
            ...
            child: ExpenseTableWidget(controller: controller, rows: rows),
          ),
        ),
      );
    });
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          ElevatedButton(
            onPressed: controller.fetchExpenseReport,
  ...
  void _openFilterSheet(BuildContext context) {
    ExpenseFilterSheet.show(context, controller);
  }
