...
class ExpenseFilterSheet extends StatelessWidget {
  ...
  const ExpenseFilterSheet({super.key, required this.controller});

  static void show(BuildContext context, ExpenseReportController controller) {
    controller.initTempFilter();
    showModalBottomSheet(
      context: context,
      isScrollControlled: true,
      backgroundColor: AppColors.transparent,
      builder: (_) => ExpenseFilterSheet(controller: controller),
    );
  }
        ...
        child: Column(
          ...
          children: [
            ...
            if (controller.isOwner) ...[
              ...
              // If not owner, show only category
              Text(
                'expense.filter.category'.trns(),
                style: const TextStyle(
                  fontSize: 13,
            ...
            Row(
              children: [
                Expanded(
                  child: _OutlineBtn(
                    label: 'expense.filter.reset'.trns(),
                ...
                Expanded(
                  child: MainBtn(
                    text: 'expense.filter.apply'.trns(),
                    onPressed: () {
