...
class ProductColumnSelectorSheet extends StatelessWidget {
  final ProductRevenueReportController controller;

  const ProductColumnSelectorSheet({super.key, required this.controller});
        ...
        children: [
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                Obx(() => Text(
                      '${'reports.product.columns.title'.trns()} (${controller.tempColumnSelected.where((e) => e).length})',
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                Text(
                  'reports.product.columns.selectColumns'.trns(),
                  style: const TextStyle(
                    fontSize: 13,
                ...
                GestureDetector(
                  ...
                  child: Text(
                    'reports.product.columns.selectAll'.trns(),
                    style: const TextStyle(
                      fontSize: 13,
                      fontWeight: FontWeight.w600,
