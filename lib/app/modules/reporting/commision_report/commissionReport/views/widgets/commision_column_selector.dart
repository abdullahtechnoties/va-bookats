...
class CommissionsColumnSelectorSheet extends StatelessWidget {
  final CommissionsReportController controller;

  const CommissionsColumnSelectorSheet({super.key, required this.controller});
        ...
        children: [
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                Obx(() => Text(
                      '${'commissions.columns.title'.trns()} (${controller.tempColumnSelected.where((e) => e).length})',
