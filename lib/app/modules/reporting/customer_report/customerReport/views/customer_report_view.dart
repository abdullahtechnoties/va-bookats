// lib/app/modules/customerReport/views/customer_report_view.dart
...
import 'package:va_bookats/app/modules/reporting/customer_report/customerReport/views/widgets/customer_filter_sheet.dart';
import 'package:va_bookats/app/modules/reporting/customer_report/customerReport/views/widgets/customer_table.dart';
...
class CustomerReportView extends GetView<CustomerReportController> {
          ...
          child: Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    '${'customerReport.columns.selected'.trns()} (${controller.selectedColumnCount})',
                    style: const TextStyle(
                      fontSize: 12,
                      fontWeight: FontWeight.w500,
                      color: Color(0xFF374151),
      ...
      return SingleChildScrollView(
        ...
        child: Padding(
          ...
          child: ClipRRect(
            ...
            child: CustomerReportTable(controller: controller, rows: rows),
          ),
        ),
      );
    });
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          Text(
            'customerReport.emptyState'.trns(),
            style: TextStyle(
              fontSize: 16,
        ...
        children: [
          ...
          Text(
            controller.reportResponse.value.message ??
                'customerReport.errors.generic'.trns(),
          ...
          ElevatedButton.icon(
            ...
            label: Text('customerReport.retry'.trns()),
  ...
  void _openFilterSheet(BuildContext context) {
    CustomerFilterSheet.show(context, controller);
  }
