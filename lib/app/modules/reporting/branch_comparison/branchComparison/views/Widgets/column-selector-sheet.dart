...
class BranchComparisonColumnSelector extends StatelessWidget {
  final BranchComparisonReportController controller;

  const BranchComparisonColumnSelector({super.key, required this.controller});
        ...
        children: [
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                Obx(() => Text(
                      '${'branchComparison.columns.title'.trns()} (${controller.tempColumnSelected.where((e) => e).length})',
          ...
          Padding(
            ...
            child: Row(
              children: [
                Expanded(
                  child: _OutlineBtn(
                    label: 'branchComparison.filter.reset'.trns(),
                ...
                Expanded(
                  child: MainBtn(
                    text: 'branchComparison.filter.apply'.trns(),
                    onPressed: () {
