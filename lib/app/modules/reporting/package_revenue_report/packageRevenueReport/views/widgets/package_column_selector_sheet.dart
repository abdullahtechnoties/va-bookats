...
class PackageColumnSelectorSheet extends StatelessWidget {
  final PackageRevenueReportController controller;

  const PackageColumnSelectorSheet({super.key, required this.controller});
        ...
        children: [
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                Obx(() => Text(
                      '${'packageRevenue.columns.title'.trns()} (${controller.tempColumnSelected.where((e) => e).length})',
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                Text(
                  'packageRevenue.columns.selectColumns'.trns(),
                  style: const TextStyle(
                    fontSize: 13,
                ...
                GestureDetector(
                  ...
                  child: Text(
                    'packageRevenue.columns.selectAll'.trns(),
                    style: const TextStyle(
                      fontSize: 13,
                      fontWeight: FontWeight.w600,
